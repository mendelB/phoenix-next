...
import './reportback-photo.scss';

const ReportbackPhoto = ({data = {}, isFetching = false, toggleReactionOn, toggleReactionOff}) => {
  ...
  return (
    <Figure className="reportback-photo" image={image} imageClassName={isFetching ? 'is-fetching' : null}>
...
export default ReportbackPhoto;
